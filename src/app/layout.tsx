...
export const metadata: Metadata = {
  ...
  description: "Specialty coffee crafted daily. Fresh roasts, expert baristas, and community vibes. Visit Brew Haven for exceptional coffee and cozy atmosphere.",
  keywords: "coffee shop, specialty coffee, espresso, latte, cold brew, local cafe",
  ...
  openGraph: {
    title: "Brew Haven - Premium Coffee Shop",
    description: "Specialty coffee crafted daily from ethically sourced beans",
    siteName: "Brew Haven",
    type: "website"
  },
  twitter: {
